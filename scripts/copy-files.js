 ...
 * like import Typography from '@snapdev-ui/core/Typography' are tree-shakeable.
 *
...
async function addLicense(packageData) {
  const license = `/** @license Snapdev-UI v${packageData.version}
 *
...
`;
  await Promise.all(
    [
      './index.js',
      './esm/index.js',
      './umd/snapdev-ui.development.js',
      './umd/snapdev-ui.production.min.js',
    ].map(async (file) => {
      try {
